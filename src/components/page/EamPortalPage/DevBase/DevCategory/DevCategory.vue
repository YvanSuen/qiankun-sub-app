    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 设备类型管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
                        ...
                        <div style="width:100%;height:600px;border:1px solid #307ecc;">
                            <el-form ref="form" status-icon style="margin-top: 100px;margin-left: 120px;">
                                 <el-form-item label="类型编码：">
                                    <el-input v-model="CategoryCode" class="handle-input-edit" disabled></el-input>
                                </el-form-item>
                                <el-form-item label="设备类型：">
                                    <el-input v-model="CategoryName" class="handle-input-edit" disabled></el-input>
                                </el-form-item>
...
import AddOrEdit from './DevCategoryEdit'
...
export default {
    ...
    methods: {
        ...
        getTreeData() {
            ...
            axios.post(EamWebApiUrl + '/EamCategory/QueryCategoryTreeList', params).then((res) => {
        ...
        handleDelete() {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                let jsonData = JSON.stringify({
                    ...
                    CategoryName : this.selectedNode.name,
                ...
                params.append('json', jsonData);
                    ...
                    axios.post(EamWebApiUrl + '/EamCategory/DeleteCategory', params).then((res) => {
                        if (res.data.returnCode == '1') {
        ...
        handleAdd() {
            ...
            this.$refs.addOrEdit.addPerson(this.obj,this.selectedNode);
        },
        clear(){
            this.selectedNode = {}
            this.CategoryCode = ''
