    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 部门编码管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
                        ...
                        <div style="width:100%;height:600px;border:1px solid #307ecc;">
                            <el-form ref="form" status-icon style="margin-top: 100px;margin-left: 120px;">
                                 <el-form-item label="部门编码：">
                                    <el-input v-model="DeptCode" class="handle-input-edit" disabled></el-input>
                                </el-form-item>
                                <el-form-item label="部门名称：">
                                    <el-input v-model="DeptName" class="handle-input-edit" disabled></el-input>
                                </el-form-item>
                                <el-form-item label="失效状态：">
                                    <input  v-model="State" class="handle-input-edit lable"  readonly :class = "{ Active : isActive }"/>
                                </el-form-item>
...
import AddOrEdit from './DepartmentPostEdit'
...
export default {
    ...
    methods: {
        ...
        getTreeData() {
            ...
            axios.post(BaseWebApiUrl + '/SysDept/QuerySysDeptTreeListVUE', params).then((res) => {
        ...
        handleDelete() {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                let jsonData = JSON.stringify({
                    DeptID : this.selectedNode.id,
                    DeptName : this.selectedNode.name,
                ...
                params.append('json', jsonData);
                    ...
                    axios.post(BaseWebApiUrl + '/SysDept/DeleteDept', params).then((res) => {
                        if (res.data.returnCode == '1') {
        ...
        handleAdd() {
            ...
            this.obj.isLeaf = '0'
            this.obj.InvalidStatus = '0'
            this.obj.number = ''
            this.obj.name = ''
            this.obj.remark = ''
            
            this.addOrEditVisible = true
            this.$refs.addOrEdit.addPerson(this.obj,this.selectedNode.id);
        },
        clear(){
            this.selectedNode = {}
            this.DeptCode = ''
